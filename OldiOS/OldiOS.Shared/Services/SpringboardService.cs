    ...
    public class SpringboardService
    {
        ...
        public void InitializeLayout()
        {
            ...
            var page1 = new List<AppInfo>
            {
                ...
                new AppInfo { Id = 3, Name = "Photos", IconPath = "_content/OldiOS.Shared/images/icons/photos.png", BundleId = "com.apple.mobileslideshow", ComponentType = typeof(Apps.Photos.PhotosApp), StatusBarStyle = StatusBarStyle.WhiteOnBlackShadow },
                new AppInfo { Id = 4, Name = "Camera", IconPath = "_content/OldiOS.Shared/images/icons/camera.png", BundleId = "com.apple.camera", ComponentType = typeof(Apps.Camera.CameraApp), StatusBarStyle = StatusBarStyle.WhiteOnBlackShadow },
                new AppInfo { Id = 5, Name = "YouTube", IconPath = "_content/OldiOS.Shared/images/icons/youtube.png", BundleId = "com.google.youtube", ComponentType = typeof(Apps.YouTube.YouTubeApp), StatusBarStyle = StatusBarStyle.WhiteOnBlackShadow },
                new AppInfo { Id = 6, Name = "Stocks", IconPath = "_content/OldiOS.Shared/images/icons/stocks.png", BundleId = "com.apple.stocks", ComponentType = typeof(Apps.Stocks.StocksApp), StatusBarStyle = StatusBarStyle.WhiteOnBlackShadow },
                new AppInfo { Id = 7, Name = "Maps", IconPath = "_content/OldiOS.Shared/images/icons/maps.png", BundleId = "com.apple.Maps", ComponentType = typeof(Apps.Maps.MapsApp), StatusBarStyle = StatusBarStyle.WhiteOnBlackShadow },
                ...
                new AppInfo { Id = 13, Name = "Game Center", IconPath = "_content/OldiOS.Shared/images/icons/gamecenter.png", BundleId = "com.apple.gamecenter", ComponentType = typeof(Apps.GameCenter.GameCenterApp), StatusBarStyle = StatusBarStyle.WhiteOnBlackShadow },
            ...
            var page2 = new List<AppInfo>
            {
                ...
                new AppInfo { Id = 16, Name = "Videos", IconPath = "_content/OldiOS.Shared/images/icons/videos.png", BundleId = "com.apple.videos", ComponentType = typeof(Apps.Videos.VideosApp), StatusBarStyle = StatusBarStyle.WhiteOnBlackShadow },
                ...
                new AppInfo { Id = 25, Name = "Compass", IconPath = "_content/OldiOS.Shared/images/icons/compass.png", BundleId = "com.apple.compass", ComponentType = typeof(Apps.Compass.CompassApp), StatusBarStyle = StatusBarStyle.WhiteOnBlackShadow },
